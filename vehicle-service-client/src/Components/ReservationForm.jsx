...
const ReservationForm = ({ token, fetchReservations }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { date, time, location, vehicleNo, mileage, message } = formData;
    ...
    try {
        await axios.post(
            ...
            { date, time, location, vehicleNo, mileage, message },
            { headers: { Authorization: `${token}` } } // Ensure the "Bearer " prefix is included
        );  
